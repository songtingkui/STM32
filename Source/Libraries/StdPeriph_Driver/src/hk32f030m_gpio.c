...
void GPIO_IOMUX_ChangePin(IOMUX_PIN eIOMUX_Pinx, uint32_t IOMUX_FuncPin)
{
  ...
  switch (eIOMUX_Pinx)
  {
    ...
    case IOMUX_PIN2://TSSOP16 TSSOP20 
      #if defined (HK32F030MD4P6) || defined (HK32F030MF4P6) 
        if((IOMUX_FuncPin == IOMUX_NRST_SEL_PA0)||(IOMUX_FuncPin == IOMUX_NRST_SEL_NRST)||(IOMUX_FuncPin == IOMUX_PD5_SEL_PD5))
        {
          if((IOMUX_FuncPin == IOMUX_NRST_SEL_PA0)||(IOMUX_FuncPin == IOMUX_NRST_SEL_NRST))
          {
						GPIOMUX->NRST_PIN_KEY = NRST_PINKEY;
          ...
          else if(IOMUX_FuncPin == IOMUX_PD5_SEL_PD5)
          {
